...
export default function MinimalistTemplate({ data, s }: TemplateProps) {
  ...
  const renderedDetails = { current: false };
  ...
  const renderSection = (id: string) => {
    switch (id) {
      case 'summary':
        ...
        return (
          <div key="summary" className="grid grid-cols-[18%_1fr] gap-4 resume-section">
      ...
      case 'experience':
        ...
        return (
          <div key="experience" className="grid grid-cols-[18%_1fr] gap-4 resume-section">
            <h3 className="font-bold text-slate-400 uppercase tracking-wider text-right" style={{ fontSize: s.textBase }}>
              Experience
            </h3>
      ...
      case 'projects':
        ...
        return (
          <div key="projects" className="grid grid-cols-[18%_1fr] gap-4 resume-section">
            <h3 className="font-bold text-slate-400 uppercase tracking-wider text-right" style={{ fontSize: s.textBase }}>
              Projects
            </h3>
            <div className={s.entryGap}>
      ...
      case 'education':
        ...
        return (
          <div key="education" className="grid grid-cols-[18%_1fr] gap-4 resume-section">
            <h3 className="font-bold text-slate-400 uppercase tracking-wider text-right" style={{ fontSize: s.textBase }}>
              Education
            </h3>
            <div className={s.entryGap}>
      ...
      case 'languages':
      case 'certifications': {
        if (renderedDetails.current) return null;
        if (skills.length === 0 && languages.length === 0 && certifications.length === 0) return null;
        renderedDetails.current = true;
        return (
          <div key="details" className="grid grid-cols-[18%_1fr] gap-4 resume-section">
            <h3 className="font-bold text-slate-400 uppercase tracking-wider text-right" style={{ fontSize: s.textBase }}>
              Details
            </h3>
